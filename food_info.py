...
malaysian_food = [
    ...
    {
        'name':'Nasi Lemak',
        'ingredients':['Rice(medium bowl)', 'Hard-Boiled Egg(100 gram)', 'Sunny Side Up Egg', 'Fried Anchovies(1 teaspoon)', 'Cucumber(1 slice)', 'Roasted Peanuts(1 teaspoon)'],
    ...
    {
        'name':'Satay',
        'ingredients':['Chicken', 'Onion', 'Garlic', 'Cumin', 'Turmeric', 'Lemongrass'],
